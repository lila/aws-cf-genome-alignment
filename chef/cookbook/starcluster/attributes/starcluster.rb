...
set_unless[:starcluster][:cluster_keypair] = "normal"

set_unless[:starcluster][:version] = "0.93"
set_unless[:starcluster][:remotefile] = "starcluster-" + node[:starcluster][:version] + ".tar.gz"
set_unless[:starcluster][:url] = "http://web.mit.edu/stardev/media/uploads/cluster/downloads/" + node[:starcluster][:remotefile]
